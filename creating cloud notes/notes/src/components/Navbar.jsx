  ...
  return (
    <div className="p-2 flex items-center justify-between relative">
      ...
      (auth)?<div className="flex items-center justify-end">
        ...
        <button className="p-2 py-1 mx-3 hover:bg-textcolor hover:text-background duration-300 rounded-md border-2 border-textcolor" onClick={()=>{window.localStorage.removeItem("auth-token");logOut()}}>Log Out</button>
      </div>:<div className="flex items-center justify-end">
      <Link to="/login">
        <button className=" p-2 py-1 mx-3 hover:bg-textcolor hover:text-background duration-300 rounded-md border-2 border-textcolor">Login</button>
        </Link>
        <Link to="/signup">
        <button className="p-2 py-1 mx-3 hover:bg-textcolor hover:text-background duration-300 rounded-md border-2 border-textcolor">Sign up</button>
        </Link>
      </div>
      }
      {show ? (
